...
| PastureStack Secret Volume | Infrastructure secret-volume driver | v0.1.0 | Public PastureStack GHCR image with an explicit version tag | Envelope authentication, encrypted delivery, read-only modes, multiple consumers, tmpfs cleanup, anonymous distribution, and HIGH/CRITICAL scan passed; complete Catalog lifecycle pending |
...
- Image: `ghcr.io/pasturestack/secrets-flexvolume-plugin:v0.1.0`
- Source: [`PastureStack/secrets-flexvolume-plugin@792d5b6b53ef352611eac6f6cccba97d887b1b36`](https://github.com/PastureStack/secrets-flexvolume-plugin/tree/792d5b6b53ef352611eac6f6cccba97d887b1b36)
- Release: [`v0.1.0`](https://github.com/PastureStack/secrets-flexvolume-plugin/releases/tag/v0.1.0)
