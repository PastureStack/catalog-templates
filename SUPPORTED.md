...
- kubectl service:
  `ghcr.io/pasturestack/kubectl-service:v0.9.11-pasturestack.3`
  from [`PastureStack/kubectl-service@b8df8dcfe87751118ca29c3dd0020e15a202a471`](https://github.com/PastureStack/kubectl-service/tree/b8df8dcfe87751118ca29c3dd0020e15a202a471)
- host-file updater:
...
Catalog version 3 is the default and uses the current package and kubectl
service releases above. Catalog version 2 remains byte-for-byte immutable for
definition comparison and rollback; its older image locks remain recorded in
`catalog-images.json` but are not the default.
