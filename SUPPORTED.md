...
| PastureStack Native | Project template | 0.3.0-rc4 | Composes only reviewed, digest-pinned infrastructure entries | Clean single-host provisioning and restart passed; restored-data validation pending |
