...
kubelet:
    ...
    {{- end }}
    image: ghcr.io/pasturestack/kubernetes-package:v1.12.10-pasturestack.4
    volumes:
        - /run:/run:rprivate
        - /var/run:/var/run:rprivate
        - /sys:/sys:ro,rprivate
        - /var/lib/docker:/var/lib/docker:rslave,z
...
etcd:
    image: ghcr.io/pasturestack/etcd-compat:v2.3.7-pasturestack.2
    labels:
        {{- if eq .Values.CONSTRAINT_TYPE "required" }}
...
kubectld:
    ...
    {{- if ne .Values.HTTP_PROXY "" }}
        ...
        NO_PROXY: ${NO_PROXY}
    {{- end }}
    image: ghcr.io/pasturestack/kubectl-service:v0.9.11-pasturestack.7
    links:
        - kubernetes
