...
It also retries transient Metadata long-poll timeouts without terminating the
scheduler. The production upgrade remained healthy for more than four minutes
with one container start, while the replaced build had accumulated repeated
starts under the same Metadata workload.
