...
# PastureStack Amazon ECR Credential Sync v3.1.5
...
- Image: `ghcr.io/pasturestack/ecr-credential-sync:v3.1.5`
- Source: [`PastureStack/ecr-credential-sync@v3.1.5`](https://github.com/PastureStack/ecr-credential-sync/tree/v3.1.5)
