...
# PastureStack Amazon ECR 登入資訊同步 v3.1.5
...
- 映像：`ghcr.io/pasturestack/ecr-credential-sync:v3.1.5`
- 原始碼：
  [`PastureStack/ecr-credential-sync@v3.1.5`](https://github.com/PastureStack/ecr-credential-sync/tree/v3.1.5)
- 上游：
