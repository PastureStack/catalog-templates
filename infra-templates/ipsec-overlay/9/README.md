...
# PastureStack IPsec Overlay 0.3.7
...
- Image: `ghcr.io/pasturestack/ipsec-vxlan-overlay-network:v0.14.34` is recorded with its published manifest digest in `catalog-images.json`. The GitHub Release itself is not immutable.
