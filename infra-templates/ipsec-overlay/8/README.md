...
# PastureStack IPsec Overlay 0.3.6
...
- Image: `ghcr.io/pasturestack/ipsec-vxlan-overlay-network:v0.14.33` is pinned to its published manifest digest in `catalog-images.json`. The GitHub Release itself is not immutable.
