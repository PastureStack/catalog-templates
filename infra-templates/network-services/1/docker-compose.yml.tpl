...
services:
  network-plugin-manager:
    image: ghcr.io/pasturestack/network-plugin-manager:v0.6.34@sha256:6a1b0f04c5ea2f8e9aac5b26b3ff950847c6fc9ca3786450072a9ca179e9e67f
    privileged: true
    network_mode: host
    pid: host
    command:
  ...
  metadata:
    image: ghcr.io/pasturestack/metadata-service:v0.9.11@sha256:00f35785580edc498f202e1d9670fecf913b5cc15f6d268912c57662a8b10723
    user: root
    cap_add:
    - NET_ADMIN
    network_mode: bridge
  ...
  dns:
    image: ghcr.io/pasturestack/internal-dns:v0.17.11@sha256:a67a68e5d370ea01d6f1b81ab7340c0ecc6acfad4ed3efdf298d038c04a00f36
