...
def test_catalog_compose_shapes_are_runtime_compatible():
    ...
    for version_id in ('2', '3', '4'):
        retained = _get_json(
            'http://localhost:8088/v1-catalog/templateversions/'
            'library:infra*kubernetes-cluster:{}'.format(version_id))
    ...
    revision_five = _get_json(
        'http://localhost:8088/v1-catalog/templateversions/'
        'library:infra*kubernetes-cluster:5')
