...
def test_catalog_list():
    ...
    assert by_folder[('template', 'web-service')]['name'] == 'Web Service'
    assert by_folder[('template', 'web-service')][
        'defaultVersion'] == '1.30.4'
...
def test_catalog_compose_shapes_are_runtime_compatible():
    ...
    web_version = _get_json(
        by_folder[('template', 'web-service')]['links']['defaultVersion'])
    ...
    health_image = (
        ...
        'sha256:9dfd47f2ec6b55faa21cd607d7a88b7761eb697bfb4132a3d4'
        'ab53ce35b3dbb7'
    )
    ...
    overlay_image = (
        ...
        'sha256:04ee8f438b8c19e49984a5319489b8c97fff7ca90459168699'
        'b6f4175f649a9b'
    )
    ...
    scheduler_image = (
        'ghcr.io/pasturestack/resource-scheduler:v0.8.14@'
        'sha256:82742768223b8e9284f02e629e831efc1809266a8f2e8fc204'
        '9821d142b5e600'
    )
