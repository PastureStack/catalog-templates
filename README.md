...
The supported set contains the `PastureStack Native` project template and ten
infrastructure entries: `PastureStack Container Schedule`, `PastureStack
System Image Preloader`, `Metadata
...
value when a translation is absent. The current eleven entries include Taiwan
